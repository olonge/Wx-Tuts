...
class Example(wx.Frame):
    ...
    def InitUI(self):
        ...
        pause = wx.BitmapButton(pnl2, bitmap=wx.Bitmap('../../icons/player/pause.png'))
        play = wx.BitmapButton(pnl2, bitmap=wx.Bitmap('../../icons/player/play.png'))
        forw = wx.BitmapButton(pnl2, bitmap=wx.Bitmap('../../icons/player/forw.png'))
        back = wx.BitmapButton(pnl2, bitmap=wx.Bitmap('../../icons/player/back.png'))
        vol = wx.BitmapButton(pnl2, bitmap=wx.Bitmap('../../icons/player/volume.png'))
