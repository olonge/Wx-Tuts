# tut_9_2_Skeleton_Spreadsheet.py
"""  """
...
class Example(wx.Frame):
    ...
    def InitUI(self):
        ...
        toolbar1.AddTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/new.png'))
        toolbar1.AddTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/open.png'))
        toolbar1.AddTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/save.png'))

        toolbar1.AddSeparator()

        toolbar1.AddTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/cut.png'))
        toolbar1.AddTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/copy.png'))
        toolbar1.AddTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/paste.png'))
        toolbar1.AddTool(wx.ID_ANY, '',  wx.Bitmap('../../icons/Spreadsheet/delete.png'))

        toolbar1.AddSeparator()

        toolbar1.AddTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/undo.png'))
        toolbar1.AddTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/redo.png'))

        toolbar1.AddSeparator()

        toolbar1.AddTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/asc.png'))
        toolbar1.AddTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/desc.png'))

        toolbar1.AddSeparator()
        toolbar1.AddTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/chart.png'))

        toolbar1.AddSeparator()
        toolbar1.AddTool(wx.ID_ANY, '',  wx.Bitmap('../../icons/Spreadsheet/exit.png'))
        ...
        toolbar2.AddCheckTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/text-bold.png'))
        toolbar2.AddCheckTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/text-italic.png'))
        toolbar2.AddCheckTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/text-underline.png'))

        toolbar2.AddSeparator()

        toolbar2.AddTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/align-left.png'))
        toolbar2.AddTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/align-center.png'))
        toolbar2.AddTool(wx.ID_ANY, '', wx.Bitmap('../../icons/Spreadsheet/align-right.png'))
