# tut_6_5_StaticBox.py
"""  Like a Frame
It is used to logically group various widgets.
Note that this widget must be created before the widgets that it contains,
and that those widgets should be siblings, not children, of the static box. """
