...
class Example(wx.Frame):
    ...
    def InitUI(self):
        ...
        toolbar.AddTool(1, 'Exit', wx.Bitmap('../../icons/advanced/exit.png'))
        toolbar.AddTool(2, 'Help', wx.Bitmap('../../icons/advanced/help.png'))
        toolbar.Realize()
        ...
        closeBtn = wx.BitmapButton(header, wx.ID_ANY, wx.Bitmap('../../icons/advanced/closebutton.png',
        ...
        helpWin.LoadPage('tut_7_3_help.html')
